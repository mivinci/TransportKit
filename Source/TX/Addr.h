...
class IPv6Addr {
 public:
  ...
  static Result<IPv6Addr, AddrParseError> Parse(const std::string &addr);
...
class IPv4Addr {
 public:
  ...
  static Result<IPv4Addr, AddrParseError> Parse(const std::string &addr);
...
class SocketAddr {
 public:
  ...
  static Result<SocketAddr, AddrParseError> Parse(const std::string &addr);
