...
#if __cplusplus >= 201703L
#define KFC_CONSTEXPR_FUNCTION constexpr
#else
#define KFC_CONSTEXPR_FUNCTION inline
#endif
...
#if defined(__GNUC__) || defined(__clang__)
#define KFC_NO_INLINE __attribute__((noinline))
#elif defined(_MSC_VER)
#define KFC_NO_INLINE __declspec(noinline)
#else
#define KFC_NO_INLINE
#endif
...
#define KFC_FORCE_DISCARD(x) (void)(x)
