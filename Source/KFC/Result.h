...
public:
  Result() = default;
  Result(const T &t) { KFC_ONEOF_SET(T, m_oneOf, t); }       // NOLINT(*-explicit-constructor)
  Result(const E &e) { KFC_ONEOF_SET(E, m_oneOf, e); }       // NOLINT(*-explicit-constructor)
  Result(T &&t) { KFC_ONEOF_SET(T, m_oneOf, std::move(t)); } // NOLINT(*-explicit-constructor)
  Result(E &&e) { KFC_ONEOF_SET(E, m_oneOf, std::move(e)); } // NOLINT(*-explicit-constructor)
...
public:
  Result() : m_err(None) {}
  Result(const E &e) : m_err(e) {}       // NOLINT(*-explicit-constructor)
  Result(E &&e) : m_err(std::move(e)) {} // NOLINT(*-explicit-constructor)
