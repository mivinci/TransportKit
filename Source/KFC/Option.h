...
public:
  ...
  constexpr Option(Option &&other) noexcept : m_ptr(other.m_ptr) { other = None; }
  ~Option() = default;
  ...
  KFC_NODISCARD bool isSome() const { return m_ptr != nullptr; }
  KFC_NODISCARD bool isNone() const { return m_ptr == nullptr; }
...
template <typename T> constexpr Option<T> Some(T &t) { return t; }
