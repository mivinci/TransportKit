...
public:
  ...
  constexpr Own(T *ptr) : m_ptr(ptr) {} // NOLINT(*-explicit-constructor)
...
public:
  ...
  constexpr Own(T *ptr, const Disposer<T> &disposer) : m_ptr(ptr), m_disposer(&disposer) {}
